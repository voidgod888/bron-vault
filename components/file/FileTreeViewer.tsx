...
// Moved outside component for performance stability
...
export function FileTreeViewer({ selectedDevice, onFileClick, onDownloadAllData }: FileTreeViewerProps) {
  ...
  // Memoize the expensive tree building operation
  const treeNodes = useMemo(() => {
    return buildASCIITree(selectedDevice.files, selectedDevice.matchingFiles)
  }, [selectedDevice.files, selectedDevice.matchingFiles])
